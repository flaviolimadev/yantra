...
$(window).ready(function(){
  ...
  spinner.on('spin:start', function(r) {
    ...
    spinner.on('spin:end', function(r) {
      ...
      //window.location.href = "{{ route('casino') }}";
      document.getElementById("bnt_click01").style.display = "none";
    });
})